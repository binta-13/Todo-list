...
export default function (ctx, inject) {
  ...
  // Register strategies
  // local
  $auth.registerStrategy('local', new scheme_003d9a64($auth, {"endpoints":{"login":{"url":"api/login","method":"post","propertyName":"token"},"logout":{"url":"v1/auth/logout","method":"post"},"user":false},"_name":"local"}))
